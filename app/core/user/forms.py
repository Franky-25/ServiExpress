...
class UserForm(ModelForm):
    ...
    class Meta:
        model = User
        fields = 'first_name', 'last_name', 'username', 'password', 'run', 'email', 'groups', 'image'
        widgets = {
            ...
            'run': forms.TextInput(attrs={'placeholder': 'Ingrese su número de cedula'}),
...
class ProfileForm(ModelForm):
    ...
    class Meta:
        model = User
        fields = 'first_name', 'last_name', 'username', 'run', 'email', 'image'
        widgets = {
            'first_name': forms.TextInput(attrs={'placeholder': 'Ingrese sus nombres'}),
            'last_name': forms.TextInput(attrs={'placeholder': 'Ingrese sus apellidos'}),
            'username': forms.TextInput(attrs={'placeholder': 'Ingrese un username'}),
