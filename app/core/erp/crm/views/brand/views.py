...
from core.erp.crm.forms import Brand, BrandForm

from core.security.mixins import AccessModuleMixin, PermissionModuleMixin


class BrandListView(AccessModuleMixin, PermissionModuleMixin, ListView):
    model = Brand
...
class BrandCreateView(AccessModuleMixin, PermissionModuleMixin, CreateView):
    model = Brand
...
class BrandUpdateView(AccessModuleMixin, PermissionModuleMixin, UpdateView):
    model = Brand
    template_name = 'brand/create.html'
    form_class = BrandForm
    success_url = reverse_lazy('brand_list')
...
class BrandDeleteView(AccessModuleMixin, PermissionModuleMixin, DeleteView):
    model = Brand
