...
from core.erp.frm.forms import TypeExpense, TypeExpenseForm
from core.security.mixins import AccessModuleMixin, PermissionModuleMixin


class TypeExpenseListView(AccessModuleMixin, PermissionModuleMixin, ListView):
    model = TypeExpense
...
class TypeExpenseCreateView(AccessModuleMixin, PermissionModuleMixin, CreateView):
    model = TypeExpense
...
class TypeExpenseUpdateView(AccessModuleMixin, PermissionModuleMixin, UpdateView):
    model = TypeExpense
    template_name = 'type_expense/create.html'
    form_class = TypeExpenseForm
    success_url = reverse_lazy('type_expense_list')
...
class TypeExpenseDeleteView(AccessModuleMixin, PermissionModuleMixin, DeleteView):
    model = TypeExpense
