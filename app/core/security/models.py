...
class Company(models.Model):
    ...
    rut = models.CharField(verbose_name='rut', max_length=13, unique=True, blank=True, null=True)
    ...
    iva = models.DecimalField(default=0.19, decimal_places=2, max_digits=9, verbose_name='Iva%')
